...
function SectionContact() {
  return (
    <section
      id="contact"
      className="bg-dasar rounded-2xl px-5 py-4 flex flex-col gap-3 z-10 h-[90vh] sticky top-0"
    >
      ...
      <div className="flex flex-col items-center gap-6">
        ...
        <div className="flex gap-2">
          ...
          />
          <ButtonIcon
            href="https://t.me/zulkifli_dev"
            alt="telegram"
            src="/svg/telegram.svg"
            target="_blank"
          />
          <ButtonIcon
            href="https://www.instagram.com/zulkifli.dev"
            alt="instagram"
            src="/svg/instagram.svg"
            target="_blank"
          />
          <ButtonIcon
            href="https://www.facebook.com/Kibot.id/"
            alt="facebook"
